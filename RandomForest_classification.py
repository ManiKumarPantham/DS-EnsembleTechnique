...
rf_clf = RandomForestClassifier(n_estimators=1000, n_jobs=1, max_features = 'sqrt', random_state=42)
...
rf_clf_grid = RandomForestClassifier(n_estimators=500, max_features = 'sqrt', n_jobs=1)
